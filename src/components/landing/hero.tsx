  ...
  return (
    <section className="relative h-screen w-full flex flex-col overflow-hidden bg-secondary">
      ...
      <div className="relative z-20 w-full h-full flex flex-col justify-end flex-grow px-6 pb-12 md:px-12">
        <div 
          className="flex flex-col lg:flex-row justify-between items-start lg:items-end w-full pb-8 md:pb-16 animate-slide-up-fade"
          style={{ animationDelay: '0.8s' }}
        >
          <div className="flex flex-row lg:flex-col gap-6 lg:gap-4 mb-12 lg:mb-0">
            {socialLinks.map((social) => (
                <Link
                  ...
                  className="flex items-center gap-3 text-base lg:text-lg font-medium text-white hover:text-accent transition-colors group"
                >
